...
// Fonction pour détecter un email temporaire via regex
const isTempEmail = (email) => {
    // Exemple général : domaines courts ou typiques de mails jetables
...
module.exports = async function handler(req, res) {
    ...
    if (isTempEmail(email)) {
        return res.status(400).json({ error: 'temp_email_not_allowed' });
    }
...
const adminTemplate = `...`; // idem que playerTemplate mais pour admin
